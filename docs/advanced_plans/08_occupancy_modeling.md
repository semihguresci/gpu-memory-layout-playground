# Advanced Investigation 08: Occupancy Modeling Against Vendor Guidance

## 1. Lecture Focus
- Concept: Resource-pressure interpretation of measured trends.
- Why this matters: Transforms benchmarking into architecture-aware analysis with explicit assumptions.
- Central question: How well do observed trends match inferred occupancy/resource limits?
...
## 4. Hypothesis
Local size, shared memory use, and register pressure proxies explain major trend shifts.

## 5. Experimental Design
### Independent variables
Local size, shared memory footprint, temporary-state complexity, barrier frequency.
...
### Metrics
Runtime trends, inferred limiter tags, mismatch notes vs expected occupancy behavior.
...
## 8. Deliverables
Kernel-by-kernel interpretation table, limiter summaries, caveat section.
