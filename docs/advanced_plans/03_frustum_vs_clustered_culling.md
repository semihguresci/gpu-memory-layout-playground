# Advanced Investigation 03: Frustum Culling vs Clustered Culling

## 1. Lecture Focus
- Concept: Comparative rendering-style visibility pipelines.
- Why this matters: Bridges kernel-level benchmarks to practical engine-level culling architecture.
- Central question: Which pipeline stages dominate cost under sparse, dense, and clustered scenes?
...
## 4. Hypothesis
Clustered pipelines outperform naive frustum-only approaches when downstream list quality and coherence matter.

## 5. Experimental Design
### Independent variables
Pipeline variant, visible ratio, scene distribution, sorted vs unsorted inputs.
...
### Metrics
Stage runtimes, total pipeline time, memory traffic estimate, sensitivity to visible count.
...
## 8. Deliverables
Stage timing charts, dominance analysis, scenario-based recommendations.
