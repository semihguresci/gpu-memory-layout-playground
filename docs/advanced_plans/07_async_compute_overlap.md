# Advanced Investigation 07: Async Compute Overlap

## 1. Lecture Focus
- Concept: Overlapping compute, transfer, and independent stages.
- Why this matters: Critical for modern GPU utilization and frame scheduling quality.
- Central question: Under what workload and contention conditions does overlap improve total completion time?
...
## 4. Hypothesis
Overlap helps when stages are truly independent and contention does not erase gains.

## 5. Experimental Design
### Independent variables
Serialized vs overlapped submission, queue usage strategy, workload mix proportions.
...
### Metrics
Total GPU wall time, overlap efficiency, stage utilization notes.
...
## 8. Deliverables
Timeline diagrams, overlap efficiency chart, practical submission rules.
